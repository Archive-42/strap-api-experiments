  ...
  _proto.preprocess = function preprocess(selected) {
    ...
    for (var _name in selected.remove) {
      ...
      if (this.data[_name].selector) {
        ...
        for (
          var _iterator2 = _createForOfIteratorHelperLoose(_prefixes), _step2;
        ...
        for (
          var _iterator3 = _createForOfIteratorHelperLoose(_prefixes), _step3;
        ...
        if (_props) {
          ...
          for (
            var _iterator4 = _createForOfIteratorHelperLoose(_prefixes), _step4;
            ...
            if (old) {
              for (
                var _iterator5 = _createForOfIteratorHelperLoose(_props),
                  _step5;
          ...
          for (
            var _iterator6 = _createForOfIteratorHelperLoose(_prefixes), _step6;
            ...
            for (
              var _iterator7 = _createForOfIteratorHelperLoose(olds), _step7;
