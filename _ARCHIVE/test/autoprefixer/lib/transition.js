...
var Transition = /*#__PURE__*/ (function () {
  ...
  _proto.add = function add(decl, result) {
    ...
    for (
      ...
      for (
        var _iterator3 = _createForOfIteratorHelperLoose(prefixer.prefixes),
          _step3;
        ...
        if (
          vendorPrefixes &&
          !vendorPrefixes.some(function (p) {
    ...
    var webkitClean = this.stringify(
    ...
    for (
      var _iterator2 = _createForOfIteratorHelperLoose(declPrefixes), _step2;
  ...
  _proto.findProp = function findProp(param) {
    ...
    if (/^\d/.test(prop)) {
      for (
        var _iterator4 = _createForOfIteratorHelperLoose(param.entries()),
          _step4;
  ...
  _proto.remove = function remove(decl) {
    ...
    var smaller = decl.parent.some(function (i) {
      return (
        i !== decl && i.prop === decl.prop && i.value.length > value.length
      );
    });
  ...
  _proto.parse = function parse(value) {
    ...
    for (
      var _iterator5 = _createForOfIteratorHelperLoose(ast.nodes), _step5;
  ...
  _proto.stringify = function stringify(params) {
    ...
    for (
      var _iterator6 = _createForOfIteratorHelperLoose(params), _step6;
  ...
  _proto.clone = function clone(origin, name, param) {
    ...
    for (
      var _iterator7 = _createForOfIteratorHelperLoose(param), _step7;
  ...
  _proto.div = function div(params) {
    for (
      var _iterator8 = _createForOfIteratorHelperLoose(params), _step8;
      ...
      for (
        var _iterator9 = _createForOfIteratorHelperLoose(param), _step9;
  ...
  _proto.cleanFromUnprefixed = function cleanFromUnprefixed(params, prefix) {
    ...
    for (
      var _iterator10 = _createForOfIteratorHelperLoose(params), _step10;
