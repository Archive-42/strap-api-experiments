...
var Resolution = /*#__PURE__*/ (function (_Prefixer) {
  ...
  _proto.clean = function clean(rule) {
    ...
    if (!this.bad) {
      ...
      for (
        var _iterator = _createForOfIteratorHelperLoose(this.prefixes), _step;
  ...
  _proto.process = function process(rule) {
    ...
    rule.params = utils.editList(rule.params, function (origin, prefixed) {
      for (
        var _iterator2 = _createForOfIteratorHelperLoose(origin), _step2;
        ...
        for (
          var _iterator3 = _createForOfIteratorHelperLoose(prefixes), _step3;
