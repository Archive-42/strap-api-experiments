...
var Gradient = /*#__PURE__*/ (function (_Value) {
  ...
  _proto.replaceFirst = function replaceFirst(params) {
    for (
      var _len2 = arguments.length,
        words = new Array(_len2 > 1 ? _len2 - 1 : 0),
        _key2 = 1;
      _key2 < _len2;
      _key2++
    ) {
  ...
  _proto.fixDirection = function fixDirection(params) {
    ...
    for (
      var _iterator3 = _createForOfIteratorHelperLoose(params), _step3;
  ...
  _proto.oldWebkit = function oldWebkit(node) {
    ...
    for (
      var _iterator4 = _createForOfIteratorHelperLoose(nodes), _step4;
  ...
  _proto.oldDirection = function oldDirection(params) {
    ...
    if (params[0][0].value !== "to") {
      ...
      for (
        var _iterator5 = _createForOfIteratorHelperLoose(params[0].slice(2)),
          _step5;
...
_defineProperty(Gradient, "names", [
  "linear-gradient",
