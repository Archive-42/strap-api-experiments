...
var Processor = /*#__PURE__*/ (function () {
  ...
  _proto.add = function add(css, result) {
    ...
    css.walkAtRules(function (rule) {
      if (rule.name === "keyframes") {
        ...
        if (
          _this.prefixes.options.supports !== false &&
    ...
    css.walkDecls(function (decl) {
      ...
      if (prop === "grid-row-span") {
        ...
        if (value === "start" || value === "end") {
          result.warn(
            value +
              " value has mixed support, consider using " +
              ("flex-" + value + " instead"),
            {
              node: decl,
            }
        ...
        if (value.includes("radial-gradient")) {
          if (OLD_RADIAL.test(decl.value)) {
            ...
            for (
              var _iterator = _createForOfIteratorHelperLoose(ast.nodes), _step;
              ...
              if (i.type === "function" && i.value === "radial-gradient") {
                for (
                  var _iterator2 = _createForOfIteratorHelperLoose(i.nodes),
                    _step2;
      ...
      if (decl.prop === "transition" || decl.prop === "transition-property") {
        ...
        if (
          prefixer &&
          prefixer.prefixes &&
          _this.gridStatus(decl, result) !== false
        ) {
          return prefixer.process(decl, result);
        }
      } else {
    ...
    return css.walkDecls(function (decl) {
      ...
      if (Array.isArray(list)) {
        for (
          var _iterator3 = _createForOfIteratorHelperLoose(list), _step3;
  ...
  _proto.remove = function remove(css, result) {
    ...
    for (
      var _iterator4 = _createForOfIteratorHelperLoose(
          this.prefixes.remove.selectors
        ),
        _step4;
    ...
    return css.walkDecls(function (decl, i) {
      ...
      for (
        var _iterator5 = _createForOfIteratorHelperLoose(
            _this2.prefixes.values("remove", unprefixed)
          ),
          _step5;
  ...
  _proto.displayType = function displayType(decl) {
    for (
      var _iterator6 = _createForOfIteratorHelperLoose(decl.parent.nodes),
        _step6;
