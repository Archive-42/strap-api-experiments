...
module.exports = function (prefixes) {
  ...
  for (
    var _iterator = _createForOfIteratorHelperLoose(prefixes.browsers.selected),
      _step;
  ...
  for (
    var _iterator2 = _createForOfIteratorHelperLoose(prefixes.add.selectors),
      _step2;
  ...
  for (var _name in prefixes.add) {
    ...
    for (
      var _iterator3 = _createForOfIteratorHelperLoose(_data.values), _step3;
