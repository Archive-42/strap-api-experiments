...
var data = require("caniuse-lite").feature(
...
var Supports = /*#__PURE__*/ (function () {
  ...
  _proto.prefixed = function prefixed(str) {
    ...
    for (
      var _iterator = _createForOfIteratorHelperLoose(rule.nodes), _step;
      ...
      for (
        var _iterator2 = _createForOfIteratorHelperLoose(
            this.prefixer().values("add", rule.first.prop)
          ),
          _step2;
  ...
  _proto.toRemove = function toRemove(str, all) {
    ...
    for (
      var _iterator3 = _createForOfIteratorHelperLoose(
          cleaner.values("remove", unprefixed)
        ),
        _step3;
  ...
  _proto.convert = function convert(progress) {
    ...
    for (
      var _iterator4 = _createForOfIteratorHelperLoose(progress), _step4;
